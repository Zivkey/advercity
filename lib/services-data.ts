    ...
    sections: [
      {
        ...
        imageAlt: "Vizuelni identitet kompanije — logo, Knjiga grafickih standarda i brendiranje objekata, Advercity agencija Nis",
      },
      {
        title: "Logo",
        ...
        imageAlt: "Dizajn logotipa i grafickog znaka za kompaniju — graficki dizajn Advercity Nis",
        reverse: true,
      },
      {
        title: "Pakovanja",
      ...
      },
      {
        ...
        imageAlt: "Dizajn reklamnih kampanja za sve medijske kanale — stampa, digital, OOH, TV, Advercity Nis",
        reverse: true,
      },
      {
        ...
        imageAlt: "Dizajn postova i banera za Instagram, Facebook, TikTok i Google Ads — Advercity digitalni marketing Nis",
      },
      {
        ...
        imageAlt: "Dizajn za outdoor oglasavanje — billboard, city light, LED i big format panoi, Advercity Nis",
        reverse: true,
      },
      {
        title: "POS marketing",
        ...
        imageAlt: "POS marketing materijali — vobleri, roll up panoi, promo pultovi i posteri, Advercity Nis",
      },
    ],
    features: [
