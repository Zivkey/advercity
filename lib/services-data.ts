...
export const SERVICE_PAGES: ServicePage[] = [
  ...
  },
  {
    ...
    metaTitle: "Graficki Dizajn Nis | Total Branding Concept | Advercity",
    metaDescription:
      "Kreativna graficka resenja i total branding concept za sve komunikacione kanale — vizuelni identitet, logo, pakovanja, digitalne i outdoor kampanje. Advercity, Nis.",
    heroSubtitle:
      "Total branding concept — kreativna resenja za efikasno prenosenje promotivnih poruka na svim komunikacionim kanalima.",
    intro:
      "Kreativna resenja i graficki koncepti kroz dizajn vizuala, za efikasno prenosenje promotivnih poruka u realizaciji marketinskih kampanja na svim komunikacionim kanalima.",
    sections: [
      {
        title: "Vizuelni identitet",
        text: "Osmislimo ime za kompaniju, brend, novi proizvod. Napisemo korporativni slogan i kljucne promo poruke. Dizajniramo vizuelni identitet, od logoa i znaka, do kompletne primene definisane kroz Knjigu grafickih standarda. Kreiramo pakovanja za sve proizvode. Brendiramo maloprodajne objekte, vozila, upravne zgrade, vas licni imidz — zaokruzeni vizuelni identitet je prva determinanta poslovnog i trzisnog identiteta kompanije.",
        image: "https://picsum.photos/seed/gd-identity/800/600",
        imageAlt: "Vizuelni identitet i branding",
      },
      {
        title: "Logo",
        text: "Slovni ispis imena kompanije ili proizvoda (logotip) zajedno sa grafickim znakom (ili nekad bez njega) predstavlja osnovni potpis vaseg brenda, pandan svojerucnom potpisu. Jedan pogled na logo koji mi dizajniramo govori vise od hiljadu reci, salje poruku i ostavlja pecat prepoznatljivosti koji ce trajati dugo.",
        image: "https://picsum.photos/seed/gd-logo/800/600",
        imageAlt: "Logo dizajn i logotip",
        reverse: true,
      },
      {
        title: "Pakovanja",
        text: "Dizajniramo lepa, prepoznatljiva, moderna, upecatljiva, unificirana, jedinstvena pakovanja proizvoda u industriji hrane, kozmetike, farmacije. Pakovanje stiti vas proizvod do momenta konzumacije, ali pre svega vizuelno mami kupce da bas njega odaberu i nekada primarno utice na prodaju. Po njemu brendovi postaju prepoznatljivi, prate trendove u bransi, diferenciraju se od konkurencije.",
        image: "https://picsum.photos/seed/gd-packaging/800/600",
        imageAlt: "Dizajn pakovanja proizvoda",
      },
      {
        title: "Dizajn kampanja za sve medijske kanale",
        text: "Kreiramo kompletne kreativne koncepte za plasiranje reklamnih kampanja na svim kanalima komunikacija kroz razlicite medije, od drustvenih mreza i web sajtova, preko stampe, OOH oglasavanja na bilbordima i led ekranima, televizije, radija, direct i POS marketinga.",
        image: "https://picsum.photos/seed/gd-campaign/800/600",
        imageAlt: "Dizajn kampanja za sve medije",
        reverse: true,
      },
      {
        title: "Dizajn kampanja za digitalni marketing",
        text: "Dizajniramo postove, banere, snimamo reels formate, za realizaciju kampanja na drustvenim mrezama (Instagram, Facebook, TikTok, LinkedIn) i na Google Ads-u.",
        image: "https://picsum.photos/seed/gd-digital/800/600",
        imageAlt: "Digitalni marketing kreative i baneri",
      },
      {
        title: "Dizajn kampanja za outdoor oglasavanje",
        text: "Dizajniramo postere za billboard, city light, LED i big formats panoe. Planiramo i realizujemo kampanje na mrezi reklamnih panoa u vlasnistvu nase agencije, kao i kroz partnerske mreze na teritoriji cele zemlje.",
        image: "https://picsum.photos/seed/gd-outdoor/800/600",
        imageAlt: "Outdoor oglasavanje billboard dizajn",
        reverse: true,
      },
      {
        title: "POS marketing",
        text: "Vobleri, posteri svih formata, roll up panoi, promo pultovi, visilice, samostalne market police, pokloni za terenske promocije, uniforme — radimo zajedno sa BTL timovima nasih klijenata na marketing kampanjama na prodajnim mestima.",
        image: "https://picsum.photos/seed/gd-pos/800/600",
        imageAlt: "POS marketing materijali",
      },
    ],
    features: [
      "Vizuelni identitet i Knjiga grafickih standarda",
